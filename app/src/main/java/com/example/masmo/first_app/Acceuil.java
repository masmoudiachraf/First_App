...
public class Acceuil extends Activity {
    ...
    private static String url_login1 = "http://192.162.42.252/Coiffeur/GetClient.php";
    private String cids;
                    ...
                    try {
                        ...
                        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                {
                                    ViewGroup row = (ViewGroup) lv.getChildAt(position);
                                    TextView tvTest = (TextView) row.findViewById(R.id.timee);
                                    String time_rv = tvTest.getText().toString();
                                    Intent tonew = new Intent(Acceuil.this,NewRV.class);
                                    tonew.putExtra("client_id",cids);
                                    tonew.putExtra("date_rv",currentdate);
                                    tonew.putExtra("time_rv",time_rv);
                                    startActivity(tonew);
                                }else
                                {
